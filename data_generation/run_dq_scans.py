...
from dataplex_integration.manage_scans import create_dq_scan, create_profiling_scan, run_scan

def main():
    PROJECT_ID = os.environ.get("GOOGLE_CLOUD_PROJECT")

    print(f"Triggering Dataplex Scans for Raw tables in project: {PROJECT_ID}...")
    ...
    try:
        ...
        print("You can monitor progress in the Google Cloud Console (Dataplex > Data scans).")
